        ...
        {currentPage === 'buy-tickets' && (
          <>
            <div className="flex justify-center mb-8 gap-4 flex-nowrap">
              <div className={`px-6 py-3 bg-white ${currentStep === 'tickets' ? 'bg-blue-600 text-white border-blue-600 shadow-lg shadow-blue-200' : 'text-gray-500 border-gray-200'} border-2 rounded-lg font-semibold transition-all duration-300 relative flex-shrink-0 min-w-[140px] text-center`}>
                1. Ingressos
              </div>
              <div className={`px-6 py-3 bg-white ${currentStep === 'checkout' ? 'bg-blue-600 text-white border-blue-600 shadow-lg shadow-blue-200' : 'text-gray-500 border-gray-200'} border-2 rounded-lg font-semibold transition-all duration-300 relative flex-shrink-0 min-w-[140px] text-center`}>
                2. Pagamento
              </div>
            </div>
            ...
            <div key={ticket.id} className="bg-white border border-gray-200 rounded-xl p-6 mb-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-blue-600">
              ...
              <div className="flex flex-col gap-4 mb-4">
                <div className="flex items-center gap-4 flex-nowrap">
                  <label className="font-semibold text-gray-600 text-sm">Quantidade:</label>
                ...
                <div className="flex items-center gap-4">
                  ...
                  {cart.find(item => item.ticketTypeId === ticket.id) && (
                    <span className="bg-green-600 text-white rounded-full px-3 py-1 text-xs font-semibold min-w-6 text-center">
                      {cart.find(item => item.ticketTypeId === ticket.id).quantity} no carrinho
                    </span>
                  )}
                </div>
              </div>
